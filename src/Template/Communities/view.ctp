...
<div class="communities view large-9 medium-8 columns content">
    ...
    <div class="related">
        <h4><?= __('Related Gotras') ?></h4>
        <?php if (!empty($community->gotras)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($community->gotras as $gotras): ?>
            <tr>
                <td><?= h($gotras->id) ?></td>
                <td><?= h($gotras->community_id) ?></td>
                <td><?= h($gotras->gotra) ?></td>
                <td><?= h($gotras->created) ?></td>
                <td><?= h($gotras->modified) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'Gotras', 'action' => 'view', $gotras->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['controller' => 'Gotras', 'action' => 'edit', $gotras->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'Gotras', 'action' => 'delete', $gotras->id], ['confirm' => __('Are you sure you want to delete # {0}?', $gotras->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
    ...
    <div class="related">
        <h4><?= __('Related Mama Gotras') ?></h4>
        <?php if (!empty($community->mama_gotras)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Community Id') ?></th>
            ...
            <?php foreach ($community->mama_gotras as $mamaGotras): ?>
            <tr>
                <td><?= h($mamaGotras->id) ?></td>
                <td><?= h($mamaGotras->community_id) ?></td>
                <td><?= h($mamaGotras->gotra) ?></td>
                <td><?= h($mamaGotras->created) ?></td>
                <td><?= h($mamaGotras->modified) ?></td>
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['controller' => 'MamaGotras', 'action' => 'view', $mamaGotras->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['controller' => 'MamaGotras', 'action' => 'edit', $mamaGotras->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['controller' => 'MamaGotras', 'action' => 'delete', $mamaGotras->id], ['confirm' => __('Are you sure you want to delete # {0}?', $mamaGotras->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
