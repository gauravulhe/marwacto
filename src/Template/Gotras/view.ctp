...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Gotra'), ['action' => 'edit', $gotra->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Gotra'), ['action' => 'delete', $gotra->id], ['confirm' => __('Are you sure you want to delete # {0}?', $gotra->id)]) ?> </li>
        <li><?= $this->Html->link(__('New Gotra'), ['action' => 'add']) ?> </li>
        <?php echo $this->element('nav_aside'); ?> 
    </ul>
</nav>
<div class="gotras view large-9 medium-8 columns content">
    <h3><?= h($gotra->id) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($gotra->users as $users): ?>
            <tr>
                <td><?= h($users->id) ?></td>
                <td><?= h($users->uuid) ?></td>
