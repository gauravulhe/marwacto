...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Mama Gotra'), ['action' => 'edit', $mamaGotra->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Mama Gotra'), ['action' => 'delete', $mamaGotra->id], ['confirm' => __('Are you sure you want to delete # {0}?', $mamaGotra->id)]) ?> </li>
        <?php echo $this->element('nav_aside'); ?> 
    </ul>
</nav>
<div class="mamaGotras view large-9 medium-8 columns content">
    <h3><?= h($mamaGotra->id) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($mamaGotra->users as $users): ?>
            <tr>
                <td><?= h($users->id) ?></td>
                <td><?= h($users->uuid) ?></td>
